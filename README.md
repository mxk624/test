...
・SNS共有機能:
使用するGem: omniauth + 使用するAPI (Twitter API, Instagram Graph API)
施術のビフォーアフターやレビューをSNSにシェアする機能を実装します。
API連携でTwitterやInstagramへの投稿を簡単に行えるようにします。
